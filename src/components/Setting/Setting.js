...
function Setting(props) {
    ...
    let getWeather = props.getSettings
    ...
    let formikOnSubmit = (values) => {
        props.setSettingsWV(values);
        props.setSettingsScaleTemperature(values);
        props.setSettingsTheme(values);
        props.setSettingsLanguage(values);
        //console.log(values)
